...
def main() -> int:
    ...
    # This command is the manual recovery path after a human has verified that
    # the real-world cause of failure was addressed. It does not advance the
    # task; it only makes the current step eligible for verify_task.py again.
